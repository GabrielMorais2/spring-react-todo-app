...
import com.gabriel.moraes.springtodoapp.exception.validationError.ValidationError;
import com.gabriel.moraes.springtodoapp.exception.validationError.ValidationErrorResponse;
...
public class ExceptionHandlerController {
    ...
    public ResponseEntity<ErrorResponse> FilmNotFoundException(TodoNotFoundException ex) {
        ErrorResponse message = new ErrorResponse(
